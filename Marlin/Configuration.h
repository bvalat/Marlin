...
#define STRING_CONFIG_H_AUTHOR "(ValatBruno, Ender3 SKR-V1.3)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "ENDER3 SKR"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -10, -3.65 }
